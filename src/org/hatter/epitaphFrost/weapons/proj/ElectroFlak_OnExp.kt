...
//ApexInsFlakExp: copy,
// Re: this is very much inspired by nicke's vfx script for the tizona
class ElectroFlak_OnExp : ProximityExplosionEffect
{
    companion object
    {
        val AOE_COLOR = Color(0, 255, 255, 255)
        val PARTICLE_COLOR = Color(70, 135, 255, 255)
        val AOE_SIZE = 100f
        val AOE_DURATION = 0.5f
    }
    ...
    override fun onExplosion(explosion: DamagingProjectileAPI, originalProjectile: DamagingProjectileAPI)
    {
        ...
        wave.size = AOE_SIZE * 0.8f
        wave.fadeInSize(AOE_DURATION)
        wave.size = AOE_SIZE * 0.2f
