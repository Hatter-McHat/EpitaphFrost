...
/*
    By Tartiflette
    -SKR_graphicLibEffects
    -SKR_gawonSystemScript
 */
public class BubbleDrive implements EveryFrameWeaponEffectPlugin {
            ...
            if(!active){
                ...
                if(MagicRender.screenCheck(1, SHIP.getLocation())){
                    ...
                    MagicRender.battlespace(
                            Global.getSettings().getSprite("fx", "ef_SKR_hueShift"),
