...
//copied from RAT
//put plugin in settings

//public static VestigeThemeGenerator vestigeThemeGenerator = new VestigeThemeGenerator();
//SectorThemeGenerator.generators.add(vestigeThemeGenerator);
public class EFSectorProcGen implements SectorProcGenPlugin {
    public static VestigeThemeGenerator vestigeThemeGenerator = new VestigeThemeGenerator();
    public static VerglasThemeGenerator  verglasThemeGenerator = new VerglasThemeGenerator();
...
//				}
        ...
        */
        ...
        EFSectorThemeGenerator.generate(context);
