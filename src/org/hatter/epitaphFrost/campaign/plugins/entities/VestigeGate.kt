package org.hatter.epitaphFrost.campaign.plugins.entities
...
//copied from RAT
class VestigeGate : BaseCustomEntityPlugin()
{
...
//
    ...
    override fun createMapTooltip(tooltip: TooltipMakerAPI, expanded: Boolean) {
        ...
        tooltip.addPara("Anomalous Gate", Misc.getGrayColor(), 3f)
    }
    ...
    override fun render(layer: CampaignEngineLayers, viewport: ViewportAPI) {
        ...
        if (layer == CampaignEngineLayers.STATIONS) {
            ...
            scannedGlowColor = Color.green
            activeGlowColor = Color.green
            var glowAlpha = 1f
