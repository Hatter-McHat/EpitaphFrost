...
//copied from RAT
class VerglasGateInteraction : EFInteractionPlugin() {
    override fun init() {
        //todo hmmm
        var plugin = interactionTarget.customPlugin as VerglasGate
        /*
         ...
         */
            ...
            createOption("Enter.") {
                ...
                (plugin.teleportLocation!!.customPlugin as VerglasGate).showBeingUsed(15f)
